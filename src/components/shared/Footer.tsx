      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:gap-0">
          ...
          <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-sm md:flex-nowrap">
            <Link 
              href="#features" 
              className="text-slate-300 hover:text-white transition-colors duration-300 hover:underline hover:decoration-blue-400"
            >
              Características
            </Link>
            <Link 
          ...
          <div className="flex items-center gap-4">
            <a 
              href="#" 
              aria-label="Twitter" 
              className="p-2 rounded-full bg-slate-800 hover:bg-blue-600 text-slate-300 hover:text-white transition-all duration-300 hover:scale-110"
            >
        ...
        <div className="mt-8 pt-8 border-t border-slate-700/50 text-center text-sm">
          <p className="text-slate-400">
            &copy; {new Date().getFullYear()} <span className="text-blue-400 font-semibold">GestorPro</span>. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
